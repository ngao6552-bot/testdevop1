...
/*By using app.use() method with the '/api/students' route as the first argument,
 you are telling Express to use this middleware for any route that starts with '/api/students'.*/
